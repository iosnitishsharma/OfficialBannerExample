...
import example.billingmodule.billing.BillingManager;
import example.billingmodule.billing.BillingProvider;
import example.billingmodule.skulist.AcquireFragment;

import static com.android.billingclient.api.BillingClient.BillingResponse;

import com.google.android.gms.ads.MobileAds;
import com.m7labs.nitishsharma.playbillingdemo_r_problem.R;
...
public abstract class BaseGamePlayActivity extends FragmentActivity implements BillingProvider {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MobileAds.initialize(this, "ca-app-pub-0664573200302260/332653322424");
